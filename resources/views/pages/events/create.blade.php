    ...
    <form action="{{ route('events.store') }}" method="POST" class="bg-white shadow-md rounded-lg p-6" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="md:col-span-2">
                ...
                <input type="text" id="heading" name="heading" value="{{ old('heading') }}" class="w-full border @error('heading') border-red-500 @else border-gray-300 @enderror rounded px-4 py-2" />
                @error('heading')
            ...
            <div>
                ...
                <input type="text" id="venue" name="venue" value="{{ old('venue') }}" class="w-full border border-gray-300 rounded px-4 py-2" />
                 @error('venue')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="text" id="city" name="city" value="{{ old('city') }}" class="w-full border border-gray-300 rounded px-4 py-2" />
                 @error('city')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="md:col-span-2">
                ...
                <input type="text" id="address" name="address" value="{{ old('address') }}" class="w-full border @error('address') border-red-500 @else border-gray-300 @enderror rounded px-4 py-2" />
                @error('address')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="number" id="price" name="price" value="{{ old('price') }}" class="w-full border @error('price') border-red-500 @else border-gray-300 @enderror rounded px-4 py-2" step="0.01" placeholder="e.g., 500.00" />
                @error('price')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="date" id="date" name="date" value="{{ old('date') }}" class="w-full border @error('date') border-red-500 @else border-gray-300 @enderror rounded px-4 py-2" />
                @error('date')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="time" id="time" name="time" value="{{ old('time') }}" class="w-full border @error('time') border-red-500 @else border-gray-300 @enderror rounded px-4 py-2" />
                @error('time')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="date" id="end_date" name="end_date" value="{{ old('end_date') }}" class="w-full border @error('end_date') border-red-500 @else border-gray-300 @enderror rounded px-4 py-2" />
                @error('end_date')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="time" id="end_time" name="end_time" value="{{ old('end_time') }}" class="w-full border @error('end_time') border-red-500 @else border-gray-300 @enderror rounded px-4 py-2" />
                @error('end_time')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
                    ...
                    <div x-show="open" @click.away="open = false" class="absolute z-10 w-full mt-1 bg-white border border-gray-300 rounded-md shadow-lg max-h-60 overflow-y-auto">
                        @foreach($categories as $category)
                            <label class="flex items-center px-4 py-2 hover:bg-gray-100 cursor-pointer">
                                <input type="checkbox" name="categories[]" value="{{ $category->id }}" {{ (is_array(old('categories')) && in_array($category->id, old('categories'))) ? ' checked' : '' }} class="form-checkbox h-4 w-4 text-orange-600 border-gray-300 rounded">
            ...
            <div class="md:col-span-2">
                ...
                <input type="text" id="artist_performer" name="artist_performer" value="{{ old('artist_performer') }}" class="w-full border border-gray-300 rounded px-4 py-2" placeholder="Artist Name (If Any)" />
            ...
            <div>
                ...
                <input type="text" id="expected_guest" name="expected_guest" value="{{ old('expected_guest') }}" class="w-full border @error('expected_guest') border-red-500 @else border-gray-300 @enderror rounded px-4 py-2" />
            ...
            <div>
                ...
                <input type="text" id="entry" name="entry" value="{{ old('entry') }}" class="w-full border @error('entry') border-red-500 @else border-gray-300 @enderror rounded px-4 py-2" />
                @error('entry')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="md:col-span-2">
                ...
                <input type="text" id="special_details" name="special_details" value="{{ old('special_details') }}" class="w-full border border-gray-300 rounded px-4 py-2" />
            ...
            <div class="md:col-span-2">
                <label for="event_image" class="block text-sm font-medium text-gray-700 mb-1">Cover Image <span class="text-red-500">*</span></label>
            ...
            <div class="md:col-span-2">
                ...
                <input type="url" id="youtube_url" name="youtube_url" value="{{ old('youtube_url') }}" class="w-full border @error('youtube_url') border-red-500 @else border-gray-300 @enderror rounded px-4 py-2" placeholder="https://youtube.com/watch?v=..." />
                @error('youtube_url')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="md:col-span-2">
                ...
                <textarea id="desc" name="desc" rows="4" class="w-full border border-gray-300 rounded px-4 py-2">{{ old('desc') }}</textarea>
                @error('desc')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="terms_and_conditions" id="terms_editor" rows="6" class="w-full border border-gray-300 rounded px-4 py-2">{{ old('terms_and_conditions') }}</textarea>
